...
- **FR-006**: If the feature includes user-facing UI, the system MUST define visual quality requirements for pages, controls, and buttons covering hierarchy, spacing, states, and modern polish
